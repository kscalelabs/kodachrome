"""Python port of the names generator from the Moby package.

See: https://github.com/moby/moby/tree/
...
def get_random_name(retry: bool) -> str:
    ...
    integer between 0 and 9 will be added to the end of the name, e.g `focused_turing3`
    """
    name: str = random.choice(left) + "_" + random.choice(right)
